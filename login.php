  ...
  <!-- Form Login -->
    <div class="container">
      ...
      <form method="POST" action="">
        ...
        <div class="mb-3" >
        <a  class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="false"><u>Buat Akun</u></a>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="verifAdmin.php">Admin</a>
          <a class="dropdown-item" href="reg_user.php">User</a>
        </div>
        </div>
